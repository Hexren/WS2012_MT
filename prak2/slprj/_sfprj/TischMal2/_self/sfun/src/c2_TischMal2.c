...
static void initialize_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance);
static void initialize_params_c2_TischMal2(SFc2_TischMal2InstanceStruct
  *chartInstance);
static void enable_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance);
static void disable_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_TischMal2(SFc2_TischMal2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_TischMal2(SFc2_TischMal2InstanceStruct
  *chartInstance);
static void set_sim_state_c2_TischMal2(SFc2_TischMal2InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance);
static void sf_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance);
static void initSimStructsc2_TischMal2(SFc2_TischMal2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_TischMal2InstanceStruct *chartInstance,
  const mxArray *c2_x1PP, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_TischMal2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_TischMal2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_TischMal2InstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_TischMal2, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_TischMal2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_TischMal2InstanceStruct *chartInstance);
...
static void initialize_c2_TischMal2(SFc2_TischMal2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_TischMal2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_TischMal2;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  chartInstance = (SFc2_TischMal2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_TischMal2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_TischMal2, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_TischMal2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_TischMal2);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_TischMal2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3765613392U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(398161219U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1833903018U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3145467188U);
}

mxArray *sf_c2_TischMal2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("RzsABSUIG2qirEpT41G0qB");
...
static const mxArray *sf_get_sim_state_info_c2_TischMal2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x1PP\",},{M[8],M[0],T\"is_active_c2_TischMal2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_TischMal2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_TischMal2InstanceStruct *chartInstance;
    chartInstance = (SFc2_TischMal2InstanceStruct *) ((ChartInfoStruct *)
...
{
  return "fBejcsjcx0r7YoPaNQNHX";
}

static void sf_opaque_initialize_c2_TischMal2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_TischMal2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_TischMal2((SFc2_TischMal2InstanceStruct*)
    chartInstanceVar);
  initialize_c2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_TischMal2(void *chartInstanceVar)
{
  enable_c2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_TischMal2(void *chartInstanceVar)
{
  disable_c2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_TischMal2(void *chartInstanceVar)
{
  sf_c2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_TischMal2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_TischMal2((SFc2_TischMal2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_TischMal2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_TischMal2(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_TischMal2((SFc2_TischMal2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_TischMal2(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_TischMal2(S);
}

static void sf_opaque_set_sim_state_c2_TischMal2(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_TischMal2(S, st);
}

static void sf_opaque_terminate_c2_TischMal2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_TischMal2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_TischMal2((SFc2_TischMal2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_TischMal2(SimStruct *S)
{
  int i;
...
static void mdlRTW_c2_TischMal2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_TischMal2(SimStruct *S)
{
  SFc2_TischMal2InstanceStruct *chartInstance;
  chartInstance = (SFc2_TischMal2InstanceStruct *)malloc(sizeof
    (SFc2_TischMal2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_TischMal2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_TischMal2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_TischMal2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_TischMal2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_TischMal2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_TischMal2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_TischMal2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_TischMal2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_TischMal2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_TischMal2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_TischMal2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_TischMal2;
...
void c2_TischMal2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_TischMal2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_TischMal2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_TischMal2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_TischMal2_method_dispatcher.\n"
