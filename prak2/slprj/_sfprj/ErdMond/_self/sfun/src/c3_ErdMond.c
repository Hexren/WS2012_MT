...
static const char * c3_debug_family_names[16] = { "xE", "eSE", "xM", "vSM",
  "rSM", "eSM", "r", "mE", "mM", "G", "F_SE", "F_SM", "nargin", "nargout",
  "xAktuell", "a" };

/* Function Declarations */
static void initialize_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void initialize_params_c3_ErdMond(SFc3_ErdMondInstanceStruct
  *chartInstance);
static void enable_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void disable_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_ErdMond(SFc3_ErdMondInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_ErdMond(SFc3_ErdMondInstanceStruct
  *chartInstance);
static void set_sim_state_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void sf_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void initSimStructsc3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance, const
  mxArray *c3_a, const char_T *c3_identifier, real_T c3_y[2]);
static void c3_b_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[2]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance,
...
static void c3_eml_int_forloop_overflow_check(SFc3_ErdMondInstanceStruct
  *chartInstance);
static void c3_eml_scalar_eg(SFc3_ErdMondInstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_ErdMondInstanceStruct *chartInstance, real_T c3_a);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_ErdMond, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_ErdMondInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_ErdMondInstanceStruct *chartInstance);
...
static void initialize_c3_ErdMond(SFc3_ErdMondInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_ErdMond = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_ErdMond;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[2];
  const mxArray *c3_y = NULL;
  SFc3_ErdMondInstanceStruct *chartInstance;
  chartInstance = (SFc3_ErdMondInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_ErdMond_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_ErdMond, const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_ErdMond), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_ErdMond);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_ErdMond_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(558380438U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3997701599U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2951219843U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(375506917U);
}

mxArray *sf_c3_ErdMond_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("l4yYPiVISBBMgbIn0gxBtC");
...
static const mxArray *sf_get_sim_state_info_c3_ErdMond(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[8],M[0],T\"is_active_c3_ErdMond\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_ErdMond_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_ErdMondInstanceStruct *chartInstance;
    chartInstance = (SFc3_ErdMondInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,747);
...
{
  return "7DErPJxXuJOEvx251KaDoC";
}

static void sf_opaque_initialize_c3_ErdMond(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_ErdMondInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
  initialize_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_ErdMond(void *chartInstanceVar)
{
  enable_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_ErdMond(void *chartInstanceVar)
{
  disable_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_ErdMond(void *chartInstanceVar)
{
  sf_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_ErdMond(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_ErdMond((SFc3_ErdMondInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_ErdMond();/* state var info */
...
extern void sf_internal_set_sim_state_c3_ErdMond(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_ErdMond((SFc3_ErdMondInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_ErdMond(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_ErdMond(S);
}

static void sf_opaque_set_sim_state_c3_ErdMond(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_ErdMond(S, st);
}

static void sf_opaque_terminate_c3_ErdMond(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_ErdMondInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_ErdMond((SFc3_ErdMondInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_ErdMond(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_ErdMond((SFc3_ErdMondInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlRTW_c3_ErdMond(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_ErdMond(SimStruct *S)
{
  SFc3_ErdMondInstanceStruct *chartInstance;
  chartInstance = (SFc3_ErdMondInstanceStruct *)malloc(sizeof
    (SFc3_ErdMondInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_ErdMondInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_ErdMond;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_ErdMond;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_ErdMond;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_ErdMond;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_ErdMond;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_ErdMond;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_ErdMond;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_ErdMond;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_ErdMond;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_ErdMond;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_ErdMond;
...
void c3_ErdMond_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_ErdMond(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_ErdMond(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_ErdMond(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_ErdMond_method_dispatcher.\n"
