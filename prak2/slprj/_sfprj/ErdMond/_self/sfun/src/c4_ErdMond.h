#ifndef __c4_ErdMond_h__
#define __c4_ErdMond_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_ErdMond;
  SimStruct *S;
...
extern void c4_ErdMond_method_dispatcher(SimStruct *S, int_T method, void *data);
