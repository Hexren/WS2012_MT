...
static void initialize_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void initialize_params_c1_ErdMond(SFc1_ErdMondInstanceStruct
  *chartInstance);
static void enable_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void disable_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_ErdMond(SFc1_ErdMondInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_ErdMond(SFc1_ErdMondInstanceStruct
  *chartInstance);
static void set_sim_state_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void sf_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void c1_chartstep_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void initSimStructsc1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance, const
  mxArray *c1_v0welt, const char_T *c1_identifier, real_T c1_y[2]);
static void c1_b_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[2]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[39]);
static void c1_eml_int_forloop_overflow_check(SFc1_ErdMondInstanceStruct
  *chartInstance);
static void c1_eml_scalar_rem90(SFc1_ErdMondInstanceStruct *chartInstance,
  real_T c1_x, real_T *c1_n, real_T *c1_y);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_ErdMond, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_ErdMondInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ErdMondInstanceStruct *chartInstance);
...
static void initialize_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ErdMond = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_ErdMond;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_ErdMond = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_ErdMond");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ErdMond(chartInstance);
...
static void sf_c1_ErdMond(SFc1_ErdMondInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ErdMond(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[2];
  const mxArray *c1_y = NULL;
  SFc1_ErdMondInstanceStruct *chartInstance;
  chartInstance = (SFc1_ErdMondInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ErdMond_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_ErdMond, const char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ErdMond), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ErdMond);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_ErdMond_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2320905890U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3515994592U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2859891505U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2790791327U);
}

mxArray *sf_c1_ErdMond_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VBuMfL6dCIKB6Qxo4eLMJE");
...
static const mxArray *sf_get_sim_state_info_c1_ErdMond(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v0welt\",},{M[8],M[0],T\"is_active_c1_ErdMond\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ErdMond_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ErdMondInstanceStruct *chartInstance;
    chartInstance = (SFc1_ErdMondInstanceStruct *) ((ChartInfoStruct *)
...
{
  return "ADjVfP8cJ1n9EwJ6BD35W";
}

static void sf_opaque_initialize_c1_ErdMond(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ErdMondInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
  initialize_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_ErdMond(void *chartInstanceVar)
{
  enable_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_ErdMond(void *chartInstanceVar)
{
  disable_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_ErdMond(void *chartInstanceVar)
{
  sf_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ErdMond(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ErdMond((SFc1_ErdMondInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ErdMond();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ErdMond(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_ErdMond((SFc1_ErdMondInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ErdMond(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ErdMond(S);
}

static void sf_opaque_set_sim_state_c1_ErdMond(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_ErdMond(S, st);
}

static void sf_opaque_terminate_c1_ErdMond(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ErdMondInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_ErdMond((SFc1_ErdMondInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ErdMond(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_ErdMond((SFc1_ErdMondInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_ErdMond(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2259689498U));
  ssSetChecksum1(S,(2308959828U));
  ssSetChecksum2(S,(1887794339U));
  ssSetChecksum3(S,(1724345294U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_ErdMond(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ErdMond(SimStruct *S)
{
  SFc1_ErdMondInstanceStruct *chartInstance;
  chartInstance = (SFc1_ErdMondInstanceStruct *)malloc(sizeof
    (SFc1_ErdMondInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ErdMondInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_ErdMond;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_ErdMond;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_ErdMond;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ErdMond;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ErdMond;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_ErdMond;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_ErdMond;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_ErdMond;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ErdMond;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ErdMond;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_ErdMond;
...
void c1_ErdMond_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ErdMond(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ErdMond(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ErdMond(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ErdMond_method_dispatcher.\n"
