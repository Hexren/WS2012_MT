...
static void sf_c2_Erdorbits(SFc2_ErdorbitsInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn(SFc2_ErdorbitsInstanceStruct *chartInstance,
  const mxArray *c2_x0, const char_T *c2_identifier, real_T c2_y[2]);
...
static void c2_eml_scalar_rem90(SFc2_ErdorbitsInstanceStruct *chartInstance,
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(527965298U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3709632113U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3163555673U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1166751399U);
}
...
mxArray *sf_c2_Erdorbits_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("r8tsBMNClQxb5yxwit7cD");
...
static const mxArray *sf_get_sim_state_info_c2_Erdorbits(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x0\",},{M[8],M[0],T\"is_active_c2_Erdorbits\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_ErdorbitsInstanceStruct *chartInstance;
    chartInstance = (SFc2_ErdorbitsInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c2_Erdorbits((SFc2_ErdorbitsInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_Erdorbits(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Erdorbits((SFc2_ErdorbitsInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_Erdorbits();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Erdorbits(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c2_Erdorbits(S);
}

static void sf_opaque_set_sim_state_c2_Erdorbits(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Erdorbits(S, st);
}
...
static void mdlSetWorkWidths_c2_Erdorbits(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2486617438U));
  ssSetChecksum1(S,(2766947960U));
  ssSetChecksum2(S,(4227979186U));
  ssSetChecksum3(S,(2422366389U));
...
{
  SFc2_ErdorbitsInstanceStruct *chartInstance;
  chartInstance = (SFc2_ErdorbitsInstanceStruct *)malloc(sizeof
