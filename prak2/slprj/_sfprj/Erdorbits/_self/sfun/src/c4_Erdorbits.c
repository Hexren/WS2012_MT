...
static void sf_c4_Erdorbits(SFc4_ErdorbitsInstanceStruct *chartInstance);
...
static void c4_eml_int_forloop_overflow_check(SFc4_ErdorbitsInstanceStruct
  *chartInstance);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(965944234U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3633543189U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(936023305U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2831564485U);
}
...
mxArray *sf_c4_Erdorbits_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hR93CsaBfzhKmkRBiDIIiG");
...
static const mxArray *sf_get_sim_state_info_c4_Erdorbits(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"endBedingung\",},{M[8],M[0],T\"is_active_c4_Erdorbits\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_ErdorbitsInstanceStruct *chartInstance;
    chartInstance = (SFc4_ErdorbitsInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,88,109,133,163);
...
{
  sf_c4_Erdorbits((SFc4_ErdorbitsInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_Erdorbits(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Erdorbits((SFc4_ErdorbitsInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Erdorbits();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Erdorbits(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c4_Erdorbits(S);
}

static void sf_opaque_set_sim_state_c4_Erdorbits(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Erdorbits(S, st);
}
...
static void mdlSetWorkWidths_c4_Erdorbits(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(154572753U));
  ssSetChecksum1(S,(1618029019U));
  ssSetChecksum2(S,(81609223U));
  ssSetChecksum3(S,(548490289U));
...
{
  SFc4_ErdorbitsInstanceStruct *chartInstance;
  chartInstance = (SFc4_ErdorbitsInstanceStruct *)malloc(sizeof
