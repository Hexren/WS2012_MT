...
static void sf_c4_Tisch(SFc4_TischInstanceStruct *chartInstance);
...
static real_T c4_emlrt_marshallIn(SFc4_TischInstanceStruct *chartInstance, const
  mxArray *c4_x1, const char_T *c4_identifier);
  ...
  const mxArray *c4_b_is_active_c4_Tisch, const char_T *c4_identifier)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_is_active_c4_Tisch),
    &c4_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1454531069U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2546695361U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1765728999U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2915793091U);
}
...
mxArray *sf_c4_Tisch_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hqGVa3kBKvmn3SJNzrCoiE");
...
static const mxArray *sf_get_sim_state_info_c4_Tisch(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x1\",},{M[8],M[0],T\"is_active_c4_Tisch\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_TischInstanceStruct *chartInstance;
    chartInstance = (SFc4_TischInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c4_Tisch((SFc4_TischInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_Tisch(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Tisch((SFc4_TischInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Tisch();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Tisch(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_Tisch((SFc4_TischInstanceStruct*)chartInfo->chartInstance,
...
{
  return sf_internal_get_sim_state_c4_Tisch(S);
}

static void sf_opaque_set_sim_state_c4_Tisch(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Tisch(S, st);
}
...
static void mdlProcessParameters_c4_Tisch(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_Tisch((SFc4_TischInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlSetWorkWidths_c4_Tisch(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2696563382U));
  ssSetChecksum1(S,(766529882U));
  ssSetChecksum2(S,(2467509574U));
  ssSetChecksum3(S,(3644683821U));
...
{
  SFc4_TischInstanceStruct *chartInstance;
  chartInstance = (SFc4_TischInstanceStruct *)malloc(sizeof
